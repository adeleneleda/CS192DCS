...
--
-- Name: x_decrementtermid(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.x_decrementtermid(p_termid integer) OWNER TO postgres;

--
-- Name: x_iod_perclass2(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.x_iod_perclass2(p_classid integer) OWNER TO postgres;
