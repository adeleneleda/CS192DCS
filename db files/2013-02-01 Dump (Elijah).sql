...
--
-- Name: ns1correction(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.ns1correction(p_studentid integer) OWNER TO postgres;
...
--
-- Name: ns2correction(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.ns2correction(p_studentid integer) OWNER TO postgres;
...
SELECT pg_catalog.setval('classes_classid_seq', 77, true);
...
SELECT pg_catalog.setval('instructorclasses_instructorclassid_seq', 78, true);
...
SELECT pg_catalog.setval('persons_personid_seq', 65, true);
...
SELECT pg_catalog.setval('studentclasses_studentclassid_seq', 710, true);
...
SELECT pg_catalog.setval('students_studentid_seq', 55, true);
...
SELECT pg_catalog.setval('studentterms_studenttermid_seq', 150, true);
