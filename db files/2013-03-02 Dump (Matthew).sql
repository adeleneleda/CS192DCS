...
DROP FUNCTION public.unitspassed(p_studentid integer);
DROP FUNCTION public.overcs197_dcorrection(p_studentid integer);
DROP FUNCTION public.overcs197_correction(p_studentid integer);
DROP FUNCTION public."overMSEE_dcorrection"(p_studentid integer);
DROP FUNCTION public."overMSEE_correction"(p_studentid integer);
DROP FUNCTION public."overFE_dcorrection"();
DROP FUNCTION public."overFE_correction"(p_studentid integer);
DROP FUNCTION public.ns2_dcorrection(p_studentid integer);
DROP FUNCTION public.ns2_correction(p_studentid integer);
DROP FUNCTION public.ns1_dcorrection(p_studentid integer);
DROP FUNCTION public.ns1_correction(p_studentid integer);
...
INSERT INTO curricula VALUES (5, 'new');
INSERT INTO curricula VALUES (6, 'old');
...
SELECT pg_catalog.setval('curricula_curriculumid_seq', 6, true);
...
INSERT INTO grades VALUES (27, '1.00', 1.00);
INSERT INTO grades VALUES (28, '1.25', 1.25);
INSERT INTO grades VALUES (29, '1.50', 1.50);
INSERT INTO grades VALUES (30, '1.75', 1.75);
INSERT INTO grades VALUES (31, '2.00', 2.00);
INSERT INTO grades VALUES (32, '2.25', 2.25);
INSERT INTO grades VALUES (33, '2.50', 2.50);
INSERT INTO grades VALUES (34, '2.75', 2.75);
INSERT INTO grades VALUES (35, '3.00', 3.00);
INSERT INTO grades VALUES (36, '4.00', 4.00);
INSERT INTO grades VALUES (37, '5.00', 5.00);
INSERT INTO grades VALUES (38, 'INC', -1.00);
INSERT INTO grades VALUES (39, 'NG', -2.00);
INSERT INTO grades VALUES (40, 'DRP', 0.00);
...
SELECT pg_catalog.setval('grades_gradeid_seq', 40, true);
