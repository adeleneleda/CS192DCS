...
<head>
	...
	<!-- Demo stuff -->
	<link href="<?= base_url('assets/css/sample-bootstrap.css') ?>" rel="stylesheet">

	<!-- Tablesorter: required for bootstrap -->
	<link rel="stylesheet" href="<?= base_url('assets/css/sample-theme.css') ?>">
	<script src="<?= base_url('assets/js/sample-tablesorter.js') ?>"></script>
	<script src="<?= base_url('assets/js/sample-theme.js') ?>"></script>
